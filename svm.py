...
train_step(data, labels, LogisticRegression(), "Logistic Regression ")
train(data, labels, LogisticRegression(), "Logistic Regression ")
...
for col in range(5):
    ...
    train_step(single_feature, labels, LogisticRegression(), "Logistic Regression")
    multiple_features = np.append(multiple_features, single_feature)
    train_step(multiple_features, labels, LogisticRegression(), "Logistic Regression")
